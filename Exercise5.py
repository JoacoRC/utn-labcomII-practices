...
print("el texto dice:",strings_concatenados)
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
strings_concatenados= f"{variable_01}{variable_02}{variable_03}{variable_02}{variable_04}{variable_05}".format(variable_01,variable_02,variable_03,variable_04,variable_05)
print("el texto dice:",strings_concatenados)
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
strings_concatenados= f'{variable_01}{variable_04}{variable_03}{variable_02}'.format(variable_01,variable_02,variable_03,variable_04)
print(strings_concatenados)
# COMPLETAR - FIN
